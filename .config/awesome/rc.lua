...
awful.spawn.with_shell("picom --experimental-backends -o 0.0")
awful.spawn.with_shell("/home/stat1k/.config/polybar/launch.sh")
awful.spawn.with_shell("feh --bg-fill ~/Wallpapers/0311.png")
...
local awesome_submenu = {
   ...
   { "Edit Config File", editor_cmd .. " " .. awesome.conffile },
